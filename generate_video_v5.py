...
OUTPUT_FILE = r"c:\Users\Manasvi Bhargava\SmartCaneApp\video_assets\draft5_final.mp4"
    ...
    try:
        ...
        if blur_phone:
            def redact(image):
                frame = image.copy()
                h, w, _ = frame.shape
                # The phone is roughly in the center, and the number is about 32-36% down the screen.
                # Narrow the X to just the center where the text is.
